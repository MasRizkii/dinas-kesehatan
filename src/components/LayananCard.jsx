...
export default function LayananCard({ subtitle, category, linkText, image }) {
  return (
    <div className="bg-white rounded-2xl shadow-md p-4 flex flex-col items-start transform transition-all duration-300 hover:scale-[1.03] hover:shadow-xl">
      ...
      <div className="flex items-center gap-1 text-[#DC3C22] mt-2 font-medium">
        {linkText} <Smile className="w-4 h-4" />
      </div>
    </div>
  );
}
